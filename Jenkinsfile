...
node
{
 ...
 stage('Build Job')
 {
   build job: 'DeployTrigger', parameters: [string(name: 'urlToClone', value: cloneurl), string(name: 'branchToClone', value: cloneBranch), string(name: 'gitID', value: gitCommitID)]
 }
}
@NonCPS
